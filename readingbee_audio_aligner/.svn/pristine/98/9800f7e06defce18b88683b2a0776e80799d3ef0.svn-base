...
public class escapeCharNewToSpace {
		  /**
		   * http://www.javapractices.com/topic/TopicAction.do;jsessionid=BF4B303580697294D16656692A50B4C8?Id=96
		   ...
		   */
		   public static String forAUDIOTXT(String aText){
		 ...
		 //   String number = padding + aIdx.toString();
		  ...
		  public static void main(String[] args) {
			  ...
			  try{
			    FileProcessing.copyStringToFile(forAUDIOTXT(FileProcessing.fileToStringBufferBr("C:/TEMP/txt/TEST.txt").toString()),"c:/TEMP/txt/TESTDONE.txt");
			  } catch (Exception e){};
		  }
